...
#def interface3():
print("What is your annual income (berofe tax): ")
while True:
    income = input()
    try:
        income = eval(income)
...
answers = [ ]
answer = "Twitter_Analysis/answers.csv"
with open(answer, "r", encoding="utf8") as a:
...
answer = "Twitter_Analysis/answers.csv"
with open(answer,"w", encoding="utf8") as a:
...
df = pd.read_csv('Twitter_Analysis/answers.csv')
